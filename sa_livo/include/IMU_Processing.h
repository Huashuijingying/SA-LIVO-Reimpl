...
public:
  ...
  void set_use_baseline_init(const bool v) { use_baseline_init_ = v; }
  void cache_init_imu(const sensor_msgs::msg::Imu::ConstSharedPtr &imu);
  void disable_imu();
...
private:
  ...
  std::vector<sensor_msgs::msg::Imu::ConstSharedPtr> init_imu_samples_;
  bool b_first_frame = true;
  bool use_baseline_init_ = false; // use original FAST-LIVO2 IMU_init averaging
  bool imu_en = true;
