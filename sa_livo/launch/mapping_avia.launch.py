...
def generate_launch_description():
    ...
    # Find path
    config_file_dir = os.path.join(get_package_share_directory("sa_livo"), "config")
    rviz_config_file = os.path.join(get_package_share_directory("sa_livo"), "rviz_cfg", "fast_livo2.rviz")
